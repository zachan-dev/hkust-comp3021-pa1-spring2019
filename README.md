...
[PA1-Skeleton.zip](Skeleton/Comp3021-PA1-Spring2019-Skeleton.zip) and finish the implementations
using the skeleton.
>
> The detailed description file can be downloaded from [here](Description/Comp3021-PA1.pdf).
>
> The executable of PA1 has been released at [here](Executables/ASCII_civilization.zip). For virtual barn's java version JDK 1.8, please download from [here](Executables/ascii-civilization_jdk1.8_for_barn.zip). 
The executable of PA1 compiled using JDK 10.0.2 is available [here](Executables/ASCII_civilizationForJDK10.0.2.zip). 
If your Windows machine complains that your Java version is too old when you run our previous executable, you can install JDK 10.0.2 (ignore it if you have installed it already) and try running this version of the executable.
Please feel free to download and unzip it to see the expected behaviors of the PA1 program.
>
